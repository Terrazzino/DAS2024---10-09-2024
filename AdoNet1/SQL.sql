...
go
--
create procedure sp_ActualizarCategoria (@codigo nvarchar(15), @descripcion nvarchar(150))
...
set @CategoriaId = (select Id from Categorias where Codigo = @CodigoCategoria);
  insert into Productos values (@codigo, @descripcion,@PrecioCompra,@PrecioVenta,@CantidadActual,@CantidadMinima,@CodigoCategoria);
end;
go
--
